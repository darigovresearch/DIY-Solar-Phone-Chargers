...
\label{sec:introduction}
  ...
  {\color{blue}\subsection{The design}} % (fold)
...
{\color{blue}\section{Avant de commencer}} % (fold)
\label{sec:avant_de_commencer}
  ...
  {\color{blue}\subsection{How to Solder}} % (fold)
...
% section avant_de_commencer (end)

\newpage

{\color{blue}\section{Construire le panneau}} % (fold)
\label{sec:Construire le panneau Construire le panneau construire_le_panneau}
  ...
  {\color{blue}\subsection{Step 1: Soldering tabbing wire to the top of the cells}} % (fold)
  ...
  {\color{blue}\subsection{Step 2: Preparing the polycarbonate and placing the cells}} % (fold)
  ...
  {\color{blue}\subsection{Step 3: Heating the EVA to stick the cells}} % (fold)
  ...
  {\color{blue}\subsection{Step 4: Tabbing the other side of the cells}} % (fold)
  ...
  {\color{blue}\subsection{Step 5: Cross tabbing}} % (fold)
  ...
  {\color{blue}\subsection{Step 6: Encapsulation}} % (fold)
  ...
  {\color{blue}\subsection{Step 7: Bonding the panel into the neoprene case}} % (fold)
  ...
  {\color{blue}\subsection{Step 8: Attach USB DC-DC voltage converter}} % (fold)
...
% section construire_le_panneau (end)

\newpage

{\color{blue}\section{Annexe 1: Se procurer les matériaux (et alternatives possibles)}} % (fold)
...
% section appendix_1_se_procurer_les_materiaux_et_alternatives_possibles_ (end)
